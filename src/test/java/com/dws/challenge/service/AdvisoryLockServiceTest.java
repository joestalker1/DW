...
public class AdvisoryLockServiceTest {
    ...
    public void testAcquireAndReleaseAccounts() {
        Optional<AdvisoryLockService.Token> locked = lockService.acquire("accId1", "accId2");
    ...
    public void testCannotAcquireTwoAccountIfOneIsAccquired() {
        assertThat(lockService.acquire()).isEmpty();
        String accId1 = "accId1";
        Optional<AdvisoryLockService.Token> locked1 = lockService.acquire(accId1);
        assertThat(locked1).isNotEmpty();
        String accId2 = "accId2";
        Optional<AdvisoryLockService.Token> locked2 = lockService.acquire(accId1, accId2);
    ...
    public void testLockBAIsTheLockABInTheSameOrder(){
       String accId1 = "A";
       String accId2 = "B";
       Optional<AdvisoryLockService.Token> locked1 = lockService.acquire(accId1, accId2);
       assertThat(locked1).isNotEmpty();
       lockService.release(locked1.get());
       Optional<AdvisoryLockService.Token> locked2 = lockService.acquire(accId2, accId1);
    ...
    public void testAcquireAccountAgainIfItWasReleased() {
        ...
        Optional<AdvisoryLockService.Token> locked1 = lockService.acquire(accId1);
        assertThat(locked1).isNotEmpty();
        assertThat(lockService.acquire(accId1)).isEmpty();
        lockService.release(locked1.get());
        locked1 = lockService.acquire(accId1);
        assertThat(locked1).isNotEmpty();
        lockService.release(locked1.get());
    }
